    ...
    <div className="flex justify-center items-center flex-col rounded-2xl drop-shadow-card">
      ...
      <div className="flex justify-between items-center w-full px-2 mt-3 font-semibold text-sm">
        ...
        <div className="flex justify-center items-center gap-3">
          <div className="flex justify-center items-center gap-2">
            <Image src="/icons/hearth.svg" width={13} height={12} alt="heart" />
            <p className="text-sm text-white">{randomLikes}</p>
          </div>
          <div className="flex justify-center items-center gap-2">
            <Image src="/icons/eye.svg" width={12} height={9} alt="eye" />
            <p className="text-sm text-white">{randomViews}</p>
          </div>
        </div>
      </div>
    </div>
