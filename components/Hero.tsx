...
const Hero = () => {
  return (
    <section className="sticky top-0  overflow-x-hidden scrollbar-hide text-white">
        ...
        <div className="my-8 flex md:flex-row flex-col py-6">
          <div className="flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16 px-6">
            ...
            <p className="max-w-[470px] mt-5 text-left text-lg">
              Welcome to Haiteku Tribe- Join us to share your passion, connect
              with fellow developers, and inspire innovation.and even more, feel
              free to showcase your work in any domain. Together, let's elevate
              the world of coding and create something extraordinary!
            </p>
          ...
          to Full Stack and UI/UX Design,  */}
          </div>
